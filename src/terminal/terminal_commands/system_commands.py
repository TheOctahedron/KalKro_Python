from terminal.terminal_commands.commands_functions import hello_world, about_kalkro, random_100

from terminal.terminal_commands.commands_functions.id_commands import show_id, enter_id
